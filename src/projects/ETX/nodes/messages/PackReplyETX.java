...
public class PackReplyETX extends Message {
	...
	private int fwdID; //ID do no que encaminhou a mensagem
	
	public PackReplyETX(){}
		
	public PackReplyETX(int hops, int path, int senderID, int sinkID, int sendTo, double ETX, double sBet, int fwdID) {
		this.hops = hops;
		this.path = path;
	...
	public Message clone() {
		return new PackReplyETX(this.hops, this.path, this.senderID, this.sinkID, this.sendTo, this.ETX, this.sBet, this.fwdID);
	}
